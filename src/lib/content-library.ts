...
export const CONTENT_LIBRARY: ContentLibraryItem[] = [
  {
    ...
    summary:
      "Balance discovery, trust, and conversion instead of making every post sell.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Start with a specific lived pain, outcome, proof point, contradiction, or curiosity gap.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Match the idea to a production format that makes the proof easy to see.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Use a daily question or tension point to create a consistent discovery series.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Turn a useful post into an owned-audience path with a real reason to respond.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Turn a proven angle into a repeatable, reviewable production package.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Build a recognizable creator persona with behavior and visual anchors that do not drift.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Make every slide earn its place with one job, readable text, and a relevant image.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Score a niche on audience urgency, buyer evidence, specificity, content depth, and monetization.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Use Postiz-inspired operating principles inside accman without importing Postiz as a whole.",
    details: [
  ...
  },
  {
    ...
    summary:
      "Marketing becomes manageable when every recommendation explains what to do next and why.",
    details: [
  ...
  {
    category: "Leads Finder",
    title: "Conversation campaigns",
    summary:
      "Extend content and outbound campaigns into qualified voice conversations without losing review controls.",
    details: [
      "Use voice agents for qualification, follow-up, support, and booking only when the contact and purpose are appropriate.",
      "Track intent, objections, calendar outcomes, and campaign economics alongside Leads Finder prospects.",
...
export const CONTENT_LIBRARY_CATEGORIES = [
  ...new Set(CONTENT_LIBRARY.map((item) => item.category)),
];
