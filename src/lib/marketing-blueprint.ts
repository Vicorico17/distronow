...
export const MARKETING_BLUEPRINT_SECTIONS: BlueprintSection[] = [
  {
    ...
    summary:
      "The user enters a website or existing business first. The app builds context before asking them to make marketing decisions.",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      "Pass confirmed profiles into DistroNow content, Leads Finder prospecting, SEO/GEO briefs, campaigns, and performance analysis.",
    ],
  },
  {
    ...
    summary:
      "The strategy layer keeps the app from producing disconnected posts that sound clever but do not build a business.",
    items: [
  ...
  },
  {
    ...
    summary:
      "The creative side should support fast generation without losing the customer, brand, or channel context behind each asset.",
    items: [
  ...
  },
  {
    ...
    summary:
      "The local lead-magnet prototype adds a conversion path so attention does not stay trapped on a social platform.",
    items: [
  ...
  },
  {
    ...
    summary:
      "Distribution is a separate category with its own dashboard, calendar, account health, platform rules, and learning loop.",
    items: [
  ...
  },
  {
    ...
    title: "Leads Finder, video, music, and livestreams connect to the core",
    summary:
      "The super app can expand without flattening different products into one confusing screen.",
    items: [
      "Leads Finder: define ICP, search companies and people, find lookalikes, review fit evidence, personalize outreach, classify replies, and track meetings/revenue.",
  ...
  },
  {
    ...
    summary:
      "The final product is not a content generator; it is a decision system with evidence, feedback, and human control.",
    items: [
...
export const SOURCE_MIGRATION_MAP = [
  {
    source: "ai-marketing-os",
    contribution:
      "Unified dashboard, accounts, calendar, analytics, content creation, ClipRO, MassCall, UGC, characters, slideshows, lead magnets, niches",
    destination: "DistroNow Studio, accman, ClipRO, AutoGTM",
  },
  {
    source: "script generation",
    contribution:
      "Hook/angle/format libraries, idea scoring, content mix, analytics, fatigue detection, exports",
    destination: "DistroNow Studio + Analytics",
  },
  {
    source: "emailing-leadmagnet",
    contribution:
      "Comment keyword, DM-to-email flow, lead magnet, nurture cadence, launch checklist",
    destination: "DistroNow Studio + AutoGTM",
  },
  {
    source: "character generation",
    contribution:
      "Identity, motivation, contradiction, voice, visual anchors, consistency rules",
    destination: "DistroNow Studio / UGC",
  },
  {
    source: "slideshows",
    contribution:
      "Slide-by-slide hook, text, image role, placement, CTA, and scoring rubric",
    destination: "DistroNow Studio / Carousel QA",
  },
  {
  ...
  },
  {
    source: "clipping",
    contribution:
      "YouTube ingestion, live/VOD handling, FFmpeg rendering, SRT captions, job logs, previews",
    destination: "ClipRO",
  },
  {
    source: "growth-agent-hub",
    contribution:
      "Read-only integration contracts, provider health, scopes, redaction, rate limits, failure modes",
    destination: "Integrations + Agent Feed",
  },
  {
    source: "postiz-app",
    contribution:
      "Calendar-first publishing, platform providers, media, sets, recurring posts, analytics, API/webhooks",
    destination: "accman (architecture reference only; no code copied)",
  },
  {
    source: "virality",
    contribution:
      "Question hooks, pattern interruption, share triggers, scoring, and safe experimentation",
    destination: "DistroNow Studio / Virality",
  },
  {
    source: "obsisdian files + obsidian-releases",
    contribution:
      "Reference/vault and release repository material, not core marketing product behavior",
    destination: "Not imported into the product",
  },
] as const;
